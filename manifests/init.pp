...
class node_builder(
  ...
  $application_classification_banner_value = "Unclassified",
  $application_classification_banner_color = "#FFFF00",
  $application_classification_banner_background_color = "#008000",
  $deploy_user="tomcat",
